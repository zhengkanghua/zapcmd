...
<template>
  <button
    type="button"
    class="queue-summary-pill relative inline-flex items-center justify-center w-[44px] h-[44px] p-0 border border-ui-brand/34 rounded-surface bg-ui-brand/12 text-ui-text leading-none cursor-pointer shadow-launcher-chip-inset transition-launcher-surface duration-150 hover:border-ui-brand/44 hover:bg-ui-brand-soft focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ui-brand/24"
