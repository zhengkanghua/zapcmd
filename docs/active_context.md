...
- `plans/2026-03-20-launcher-search-effective-height-inheritance-and-panel-contract.md`：Search breathing token；替代`2026-03-20-launcher-command-flow-height-contract-correction.md`；`check:all`绿。
