...
4. 多语言：`vue-i18n`。
5. 构建：Vite。
6. 样式：TailwindCSS + `src/styles.css`。
...
docs/.maintainer/           维护者/Agent 内部资料（跑书/人工回归/个人手册/归档）
...
人工回归清单：`docs/.maintainer/work/manual_regression_m0_m0a.md` / `docs/.maintainer/work/manual_regression_m4_release.md`
